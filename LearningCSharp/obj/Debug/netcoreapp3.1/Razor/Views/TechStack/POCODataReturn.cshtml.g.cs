#pragma checksum "C:\Users\drbor\source\repos\LearningCSharp\LearningCSharp\Views\TechStack\POCODataReturn.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0457217de29be44791eed583a0556585462c1575"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0457217de29be44791eed583a0556585462c1575", @"/Views/TechStack/POCODataReturn.cshtml")]
...
<div class=""card text-center"">
    <div class=""card-body"">
        ...
        <ul class=""list-group"">
            <li class=""list-group-item list-group-item-secondary"">When generating a View, it is important to select the Razer View Option</li>
            <li class=""list-group-item list-group-item-success"">Razer View Provides options for What Class the data will be Instantiated from</li>
            <li class=""list-group-item list-group-item-danger"">For Websites such as this it is important to select the layout.cshtml, to keep page consistency</li>
            <li class=""list-group-item list-group-item-warning"">Once generated, the content can be wrapped like it is on this page, and edited using Bootstrap classes!</li>
        </ul>
...
#line hidden
#nullable disable
            WriteLiteral("            </tbody>\r\n        </table>\r\n    </div>\r\n</div>\r\n<h1 class=\"text-center\" style=\"padding:20px\">Returning data from the T-SQL Database</h1>");
        }
